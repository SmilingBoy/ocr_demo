...
Java_com_baidu_paddle_ocr_core_OCRPredictorNative_init(
...
Java_com_baidu_paddle_ocr_core_OCRPredictorNative_forward(
...
Java_com_baidu_paddle_ocr_core_OCRPredictorNative_release(
